...
is the 0-based index of the fragment within the whole source, continuous
across pages. ``fragment_id`` is the lowercase-hex SHA-256 of UTF-8
``source_id``, ``page_number``, ``sequence`` and ``text`` joined by ``"\n"``.
"""
